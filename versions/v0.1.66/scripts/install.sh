...
DEFAULT_SCRIPT_DIR="${CLI_INSTALL_SCRIPT_DIR:-scripts}"
BRAND_SLUG="${CLI_BRAND_SLUG:-devsprouts}"
BIN_NAME="${CLI_BIN_NAME:-devsprouts}"
BRAND_NAME="${CLI_BRAND_NAME:-${BIN_NAME:-${BRAND_SLUG:-cli}}}"
CONFIG_DIR_NAME="${CLI_CONFIG_DIR_NAME:-devsprouts}"
PACKAGE_SCOPE_DEFAULT="${CLI_PACKAGE_SCOPE:-@dev-sprouts}"
PACKAGE_NAME_DEFAULT="${CLI_PACKAGE_NAME:-devsprouts-cli}"
