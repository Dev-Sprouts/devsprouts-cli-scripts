...
DEFAULT_REPO="${CLI_INSTALL_REPO:-}"
DEFAULT_REF="${CLI_INSTALL_REF:-main}"
BRAND_SLUG="${CLI_BRAND_SLUG:-}"
BIN_NAME="${CLI_BIN_NAME:-${BRAND_SLUG:-}}"
CONFIG_DIR_NAME="${CLI_CONFIG_DIR_NAME:-${BRAND_SLUG:-}}"
PACKAGE_SCOPE_DEFAULT="${CLI_PACKAGE_SCOPE:-}"
PACKAGE_NAME_DEFAULT="${CLI_PACKAGE_NAME:-}"
